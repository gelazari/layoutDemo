...
class Window(QtGui.QWidget):
    ...
    def createTopFrame(self):
        ...
        logo_button.setIcon( QtGui.QIcon(r'./images/left_buttons/grid.svg'))
        ...
        share_button = QtGui.QPushButton("Share")
    ...
    def createLeftFrame(self):
       ...
       # controller_button.clicked().connect(self.sectionChanged(0))
        ...
        pattern_button = QtGui.QPushButton("Pattern")
        ...
        traces_button = QtGui.QPushButton("Traces")
